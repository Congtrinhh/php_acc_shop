                ...
                <table border="1"  cellspacing="0.4px" >
                    ...
                    while($row = $query->fetch_row()) {
                        ...
                        <tr>
                            ...
                            <td width=300px><img width='100px' src='./../img/". $row[3] ."'/></td>
                            <td width=200px> <button><a href='./SuaDM.php?id=".$row[0] ."'>Sửa</a></button><button '><a href='./XoaDM.php?id=".$row[0] ."'onclick='return XacNhanXoa()'>Xóa</a></button></td>
