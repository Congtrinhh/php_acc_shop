                        ...
                        <?php
                            ...
                            while($row = $query->fetch_row()) {
                                ...
                                <tr>
                                    ...
                                    <td width=200px> <button><a href='./EditCategory.php?id=".$row[0]."'>Sửa</a></button><button '><a href='./DeleteCategory.php?id=".$row[0] ." 'onclick='return XacNhanXoa()'>Xóa</a></button></td>
                                </tr>
                                </table>";
                            }
                        ?>
